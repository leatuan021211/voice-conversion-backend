...
class Generator(torch.nn.Module):
    ...
    @classmethod
    def load_from_checkpoint(cls, checkpoint_path: str, config: dict) -> 'Generator':
        """
        ...
        """
        checkpoint = load_checkpoint(checkpoint_path, AIModelSettings.DEVICE)
        hyper_params = AttrDict(config)
